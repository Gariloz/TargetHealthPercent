...
-- Fallback localization if main one didn't load
...
-- Dynamic generation of threshold options
local function GenerateThresholdOptions()
    ...
    local args = {}
    -- Initialize threshold array if it doesn't exist
    ...
    args.addThreshold = {
        ...
        func = function()
            if not TargetHealthPercent.db then
                print("ERROR: Database not initialized when adding threshold!")
                return
            end
            ...
            print("Added threshold: " .. newThreshold.name .. " (" .. newThreshold.value .. "%)")
            print("Total thresholds: " .. #TargetHealthPercent.db.profile.thresholds)
            ...
            args = {
                ...
                remove = {
                    ...
                    func = function()
                        ...
                        print("Threshold removed. Remaining thresholds: " .. #TargetHealthPercent.db.profile.thresholds)
...
-- If database is already initialized, create configuration immediately
